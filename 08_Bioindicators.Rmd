...
`r msmbstyle::question(label = "ques:one", text = "Describe the expected relationship for of the number of individuals caught with increasing sampling effort.")`
...
`r msmbstyle::question(label = "ques:two", text = "Briefly describe your results by comparing differences among the varying levels of pollution.")`

Next, let's look at the number of species caught in each sample.

`r msmbstyle::question(label = "ques:three", text = "Describe the expected relationship for of the number of species caught with increasing sampling effort. Then plot your data as a scatterplot to see if you are correct.")`
...
`r msmbstyle::question(label = "ques:four", text = "Briefly describe your results by comparing differences among the varying levels of pollution.")`

Finally, let's use our results to design our sampling scheme.

`r msmbstyle::question(label = "ques:five", text = "Given this information, briefly discuss how you would design your sampling scheme to compare species assemblages amoung streams with varying levels of pollution.")`
...
`r msmbstyle::question(label = "ques:seven", text = "Discuss your results. Remember, discuss means that you should both briefly describe and interpret them.")`
...
`r msmbstyle::question(label = "ques:eight", text = "Discuss your results.")`
...
`r msmbstyle::question(label = "ques:ten", text = "Discuss your results.")`
...
`r msmbstyle::question(label = "ques:eleven", text = "Briefly consider how you would expect your figure to differ for each of those two scenarios.")`
...
`r msmbstyle::question(label = "ques:twelve", text = "Discuss your results and argue whether differences you are seeing are the result of sampling effects or if there are species-specific effects due to different levels of pollution. Refer to your answer to the question above.")`


## Ecological Indicators and Bioindicators

`r msmbstyle::question(label = "ques:thirteen", text = "In our discussion of the strategic value of species diversity, we briefly touched on the concept of indicator species. Briefly outline what an indicator species is and how it differs from a flagship and an umbrella species, two groups that also carry significant stratgic value for conservation efforts. Use specific examples as needed and consider whether a species could fall into all three categories.")`
