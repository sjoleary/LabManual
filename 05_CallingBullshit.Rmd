...
`r tufte::margin_note("A large portion of the content of this lab draws on Carl Bergstrom and Jevin West's course and book on (Calling Bullshit: The Art of Skepticism in a Data-Driven World)[https://www.callingbullshit.org/]. Their course is online, including videos, it's entertaining and informative. Put the book on your Christmas wishlist.")` 
...
* have a simple toolkit for assessing sources on the interwebs.
...
Misinformation describes erroneous/incorrect information, by contrast disinformation is the deliberate use of false information with an intent to mislead, similar propaganda which is biased and/or misleading information use to promote a specific cause or point of view.
...
`r msmbstyle::question(label = "ques:two", text = "Brandolini's Law, also known as the BS asymmetry principle, states that the amount of energy needed to refute bullshite is an order of magnitude bigger than to produce it. Briefly give three arguments supportint this principle.")`

In [The Fine Art of Baloney Detection](http://www.inf.fu-berlin.de/lehre/pmo/eng/Sagan-Baloney.pdf
), Carl Sagan lists nine things to consider in order to identify misinformation: 
...
Ask yourself three questions when evaluating a source of information:
...
This principle a cousin to **Occam's Razor** - known as the **Law of Parsimony**. 
...
Taking this to *ad absurdum* we have fun example involving [chocolate and Nobel laureates](https://www.nejm.org/doi/full/10.1056/nejmon1211064) along with [storks and babies](https://web.stanford.edu/class/hrp259/2007/regression/storke.pdf).
...
In one of their exhibits, the Pacific Science Center emphasizes four principles:
...
Sometimes it is important to [slow down](http://slow-science.org/) and give science an chance to breath and mature through discussion and testing.

This is important to keep in mind when watching science unfold in real time and out in the open via social media, pre-prints (before peer-review) and in media outlets.
...
"New studies find ... " makes for a great headline, unfortunately occasionally both deliberately and unintentionally by the time the "new study" is translated into a press release and that press release is written up in the media misinformation or disinformation may have sneaked in. This may include

* cherry-picking
* over-generalizing (see `# In Mice` [examples](https://twitter.com/hashtag/inmice?lang=en) and an article describing the intent.)
...
`r tufte::margin_note("It is alright to decorate construction but never construct decoration. Augustus Welby Northmore Pugin")`
...
`r msmbstyle::question(label = "ques:seven", text = "List examples for primary literature and secondary literature. Give a brief description of what peer-review is and argue the benefits.")`
...
Peer-review doesn't guarantee that a paper is correct - it is indented to ensure that the methods being used a reasonable/appropriate, that the reasoning is logical, that conclusions follow from the results and that the paper accurately represents and adds to the literature. 

To establish legitimacy you can check a few things:

* Where was the paper published (legitimacy of journal) and did it go through peer-review? Is it a legitimate or predatory publisher? Is it in a pre-print archive?
* Are the claims commensurate with the journal (big claims, obscure journal? That should raise some flags)?
* Has the paper been retracted or seriously questioned? It's not uncommon to have some controversy including some back and forth between papers being published - that is a sharpening of ideas and good for science. Unconvering misconduct leading to retraction is not.
...
> *"False positives and exaggerated results in peer-reviewed scientific studies have reached epidemic proportions in recent years, The problem is rampant in economics, the social sciences and even the natural sciences, but it is particularly egregious in biomedicine". John Ioaniddis, An Epidemic of False Claims*

There is ongoing controversy with an increasing number of studies especially in the psychological, medical, social sciences not being reproducible. There are efforts to require both code and data analysis to be deposited along with the paper for increased accountability.
...
Apart from the information overload and misinformation/disinformation being presented (see section above) the internet has now given us a new category of information where advertising & public information blur commercial and information ... everybody can publish their ideas, this is both helpful to give voice to people who don't usually have a platform but it also means it's increasingly difficult to weed through the noise, your sources now don't just include primary and secondary literature you also have other informational websites, news/media outlets, advocacy (NGOs, think tanks, ...), business/marketing, personal webpages, social media and blogs.

Here is a basic toolkit to evaluate internet resources next to all the principles we have laid out previously:

* Accuracy
    + Is the website reliable? free from error? were fact checkers/editors involved?
* Authority: 
    + Who are the authors? 
    + Are they reputable? 
...
* Publishing body/affiliation?
    ...
    + Is somebody/organization sponsiring the website? What is their reputation?
* Objectivity: 
    + Is there bias? 
...
`r msmbstyle::question(label = "ques:eight", text = "Here are four links to information about sharks - choose two websites, make a brief assessment of the website and argue whether or not use would use the information on that webpage for a presentation on sharks.")`

* [Site 1](https://www.worldwildlife.org/species/shark)
* [Site 2](https://www.sharktrust.org/blog/5-extraordinary-connections-sharks-share-with-other-animals)
* [Site 3](https://www.sharkconservationfund.org/drivers-of-the-crisis/)
* [Site 4](https://www.welovesharks.club/just-like-humans-sharks-personalities/)
