...
Complete lab 11 ([Population Modeling](https://labmanual.netlify.app/population-modeling.html))) and submit the knitted `html`-files through Canvas (`HW-p`).
...
Complete lab 11 ([Shark Fin Market Analysis](https://labmanual.netlify.app/shark-fin-trade-monitoring.html))) and submit the knitted `html`-files through Canvas (`HW-8`).
